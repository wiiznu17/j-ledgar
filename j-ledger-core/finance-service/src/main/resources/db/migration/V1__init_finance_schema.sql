...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    type VARCHAR(50) NOT NULL, -- TRANSFER, TOPUP, WITHDRAWAL, PAYMENT
...
CREATE INDEX IF NOT EXISTS idx_holds_wallet_id ON transaction_holds(wallet_id);
CREATE INDEX IF NOT EXISTS idx_holds_transaction_id ON transaction_holds(transaction_id);
CREATE INDEX IF NOT EXISTS idx_holds_status ON transaction_holds(status);
