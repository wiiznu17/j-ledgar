...
async function main() {
  ...
  // --- CORE SYSTEM SEEDING (Runs in ALL environments) ---
  console.log('💰 Ensuring Finance Service core settings and system accounts...');
  try {
  ...
  // 7. Seed Merchant Ecosystem (Minimal) - Only in Non-Production
  if (!isProduction) {
