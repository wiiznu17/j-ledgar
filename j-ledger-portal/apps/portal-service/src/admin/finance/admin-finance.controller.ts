...
export class AdminFinanceController {
  ...
  async getDisputes(
    ...
    return this.adminFraudService.getDisputes(page, limit, search, status, type);
  }

  @Post('disputes/:id/reverse')
  @Roles(AdminRole.SUPER_ADMIN, AdminRole.AUDITOR, AdminRole.SUPPORT_AGENT)
  async reverseDispute(@Param('id') id: string): Promise<{ success: boolean }> {
    return this.adminFraudService.reverseDispute(id);
  }
  ...
  async getBlacklistNodes(): Promise<{ data: any[] }> {
    return this.adminFraudService.getBlacklistNodes();
  }
  ...
  async blockNode(
    ...
    return this.adminFraudService.blockNode(body.type, body.target, body.reason);
  }
  ...
  async unblockNode(
    ...
    return this.adminFraudService.unblockNode(body.type, body.target);
  }
}
