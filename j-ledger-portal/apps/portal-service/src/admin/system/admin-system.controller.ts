...
export class AdminSystemController {
  ...
  async getApprovals(
    ...
    return this.adminApprovalService.getApprovals(page, limit, search, status, category);
  }
  ...
  async createApproval(@Body() body: any) {
    return this.adminApprovalService.createApproval(body);
  }
  ...
  async decideApproval(
    ...
    return this.adminApprovalService.decideApproval(id, body);
  }
