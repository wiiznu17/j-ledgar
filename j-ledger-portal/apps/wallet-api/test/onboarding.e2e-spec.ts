...
describe.skip('Onboarding Flow (e2e) - Skipped due to BFF refactor', () => {
  ...
  // These tests need to be refactored to mock proxy services or test against actual microservices
