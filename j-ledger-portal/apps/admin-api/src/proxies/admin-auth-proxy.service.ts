...
export class AdminAuthProxyService {
  ...
  async deactivateStaff(id: string) {
    const response = await firstValueFrom(
      this.httpService.post(
        `${this.baseUrl}/admin/staff/${id}/deactivate`,
        {},
  ...
  async reactivateStaff(id: string) {
    const response = await firstValueFrom(
      this.httpService.post(
        `${this.baseUrl}/admin/staff/${id}/reactivate`,
        {},
        { headers: this.headers },
      ),
    );
  ...
  async searchStaff(query: string) {
    const response = await firstValueFrom(
      this.httpService.get(`${this.baseUrl}/admin/staff/search/${query}`, {
        headers: this.headers,
      }),
    );
    return response.data;
  ...
  async assignRole(staffId: string, roleId: string) {
    const response = await firstValueFrom(
      this.httpService.post(
        `${this.baseUrl}/admin/staff/${staffId}/roles/${roleId}`,
        {},
        { headers: this.headers },
      ),
    );
  ...
  async removeRole(staffId: string, roleId: string) {
    const response = await firstValueFrom(
      this.httpService.delete(`${this.baseUrl}/admin/staff/${staffId}/roles/${roleId}`, {
        headers: this.headers,
      }),
    );
    return response.data;
  ...
  async updatePermission(id: string, data: any) {
    const response = await firstValueFrom(
      this.httpService.put(`${this.baseUrl}/admin/permissions/${id}`, data, {
        headers: this.headers,
      }),
    );
    return response.data;
