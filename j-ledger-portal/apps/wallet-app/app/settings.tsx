...
export default function SettingsScreen() {
  ...
  const renderSettingItem = (icon: any, title: string, subtitle?: string, rightElement?: React.ReactNode) => (
    ...
    <SafeAreaView className="flex-1 bg-[#f5f6fc]">
       <View className="px-6 mt-6 mb-6 flex-row items-center gap-4">
         <TouchableOpacity 
          ...
          <Text className="text-xl font-manrope font-black text-on-surface tracking-tight">Settings</Text>
      </View>
      ...
      >
        <Text className="text-[10px] font-manrope font-black text-secondary uppercase tracking-[0.3em] mb-4 px-1">Application</Text>
        <GlassPanel intensity={20} className="p-1 px-5 rounded-[35] mb-10">
           {renderSettingItem(<Globe />, "Language", "English (United States)")}
           {renderSettingItem(<Moon />, "Appearance", "Standard Light Mode", 
             <Switch 
               value={isDarkMode} 
        ...
        <Text className="text-[10px] font-manrope font-black text-secondary uppercase tracking-[0.3em] mb-4 px-1">Security & Privacy</Text>
        <GlassPanel intensity={20} className="p-1 px-5 rounded-[35] mb-10">
           {renderSettingItem(<Lock />, "Change Secret PIN", "Update your 6-digit access")}
           {renderSettingItem(<Fingerprint />, "Biometrics", "Face ID & Touch ID",
             <Switch 
               value={isBiometric} 
        ...
        <Text className="text-[10px] font-manrope font-black text-secondary uppercase tracking-[0.3em] mb-4 px-1">Other</Text>
