        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View className="mb-10">
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} className="-mx-2">
                ...
                >
                  ...
                  >
                    <Image
                      ...
                      className="w-16 h-16 rounded-[22] border-4 border-white shadow-xl mb-3"
                    />
                    <View className="absolute bottom-4 right-0 w-5 h-5 bg-green-500 rounded-full border-2 border-white" />
                  </MotiView>
                  <Text className="text-[10px] font-manrope font-black text-on-surface uppercase tracking-tighter">
                    {contact.name}
                  </Text>
                </TouchableOpacity>
              ))}
              <TouchableOpacity className="items-center mx-3">
                ...
                <Text className="text-[10px] font-manrope font-black text-secondary uppercase tracking-tighter">
                  View All
                </Text>
              </TouchableOpacity>
            </ScrollView>
          ...
          <View className="bg-primary/5 p-5 rounded-[28] border border-primary/10 flex-row items-center gap-4 mb-12">
            ...
            <Text className="text-[10px] font-manrope font-bold text-on-surfaceVariant leading-[1.6] flex-1">
              Please confirm the recipient's identity before proceeding. Unauthorized transfers
              cannot be refunded.
            </Text>
          </View>
