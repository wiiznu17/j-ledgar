    ...
    <SafeAreaView className="flex-1 bg-[#f5f6fc]">
      <View className="flex-1 px-8 items-center justify-center">
        ...
        <View className="items-center mb-10">
          ...
          >
            <Text className="text-3xl font-manrope font-black text-on-surface text-center mb-1 tracking-tight">Transfer Sent!</Text>
        ...
        <MotiView
           ...
           className="w-full"
        >
          <GlassPanel intensity={30} className="w-full p-8 mb-10 border-white/40 shadow-2xl shadow-green-900/5">
             <View className="items-center mb-8 pb-8 border-b border-outline-variant/10">
                <Text className="text-[10px] font-manrope font-black text-secondary uppercase tracking-[0.3em] mb-4">Amount Sent</Text>
             ...
             <View className="space-y-5">
                <View className="flex-row justify-between items-center">
                   <Text className="text-[10px] font-manrope font-black text-on-surfaceVariant/40 uppercase tracking-widest">Recipient</Text>
                   <Text className="text-sm font-manrope font-black text-on-surface">SOMCHAI DEEJA</Text>
                </View>
                <View className="flex-row justify-between items-center">
                   <Text className="text-[10px] font-manrope font-black text-on-surfaceVariant/40 uppercase tracking-widest">Ref. Code</Text>
                   <View className="flex-row items-center gap-2">
                      <Text className="text-sm font-manrope font-black text-on-surface">TXN-88220015</Text>
                      <ShieldCheck size={12} color="#16a34a" />
                   </View>
                </View>
                <View className="flex-row justify-between items-center">
                   <Text className="text-[10px] font-manrope font-black text-on-surfaceVariant/40 uppercase tracking-widest">Status</Text>
                   <View className="bg-green-100 px-3 py-1 rounded-lg">
                      <Text className="text-[10px] font-manrope font-black text-green-700 uppercase">Settled</Text>
                   </View>
                </View>
             </View>
          </GlassPanel>
        ...
        <View className="flex-row gap-5 w-full mb-8">
           <TouchableOpacity className="flex-1 h-16 rounded-[24] bg-white/60 border border-outline-variant/10 items-center justify-center flex-row gap-3 shadow-sm active:scale-95">
              ...
              <Text className="text-xs font-manrope font-black text-[#4855a5] uppercase tracking-tight">Share</Text>
           </TouchableOpacity>
           <TouchableOpacity className="flex-1 h-16 rounded-[24] bg-white/60 border border-outline-variant/10 items-center justify-center flex-row gap-3 shadow-sm active:scale-95">
              <Download size={20} color="#4855a5" />
              <Text className="text-xs font-manrope font-black text-[#4855a5] uppercase tracking-tight">E-Slip</Text>
           </TouchableOpacity>
        </View>
