      ...
      <View className="flex-1 px-8">
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View className="items-center mb-10">
            ...
            <Text className="text-3xl font-manrope font-extrabold text-on-surface text-center mb-2">
              Account Recovery
            </Text>
          ...
          <GlassPanel className="mt-12 mb-10" intensity={10}>
            <Text className="text-[10px] font-manrope font-black uppercase tracking-widest text-on-surfaceVariant mb-2 text-center">
              Security Tip
            </Text>
