...
export default function ProfileScreen() {
  ...
  const renderMenuItem = (icon: any, title: string, subtitle?: string, route?: string, color: string = "#4855a5") => (
    <TouchableOpacity 
    ...
    >
      <View className="flex-row items-center gap-5">
        ...
        <View>
          ...
          {subtitle && <Text className="text-[10px] font-manrope font-bold text-on-surfaceVariant/60 uppercase tracking-widest mt-1">{subtitle}</Text>}
        </View>
      </View>
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#f5f6fc]">
      ...
      >
        {/* Profile Card */}
        <GlassPanel intensity={40} className="mb-12 p-8 relative overflow-hidden shadow-2xl shadow-primary/5">
           <View className="absolute top-[-50] right-[-50] w-[180] h-[180] bg-primary/10 rounded-full" style={{ filter: [{ blur: 60 }] }} />
           ...
           <View className="items-center">
              ...
              <Text className="text-2xl font-manrope font-black text-on-surface mb-1">{MOCK_USER.name}</Text>
              <Text className="text-sm font-manrope font-bold text-on-surfaceVariant/60 mb-4">{MOCK_USER.email}</Text>
              ...
              <View className="flex-row gap-3">
                 <View className="bg-primary/10 px-4 py-2 rounded-xl flex-row items-center gap-2 border border-primary/10">
                    ...
                    <Text className="text-[10px] font-manrope font-black text-primary uppercase tracking-widest">Premium Member</Text>
                 </View>
              </View>
           </View>
        </GlassPanel>
        ...
        <View className="mb-10">
           <Text className="text-[10px] font-manrope font-black text-secondary uppercase tracking-[0.3em] mb-4 px-1">Account & Security</Text>
        ...
        <View className="mb-10">
           <Text className="text-[10px] font-manrope font-black text-secondary uppercase tracking-[0.3em] mb-4 px-1">Preferences</Text>
           <GlassPanel intensity={20} className="p-1 px-5 rounded-[35]">
              {renderMenuItem(<Bell />, "Notification Center", "Alert Settings, History", "/notifications")}
              <View className="border-0">
                 {renderMenuItem(<Settings />, "App Preferences", "Display, Language, Clear Cache", "/settings")}
              </View>
           </GlassPanel>
        </View>
        ...
        <View className="mb-12">
           <Text className="text-[10px] font-manrope font-black text-secondary uppercase tracking-[0.3em] mb-4 px-1">Support & Legal</Text>
           <GlassPanel intensity={20} className="p-1 px-5 rounded-[35]">
        ...
        >
          ...
          >
            ...
            <Text className="text-white font-manrope font-black text-lg uppercase tracking-tight">Sign Out</Text>
          </TouchableOpacity>
        </MotiView>
