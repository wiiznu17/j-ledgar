    ...
    <View className="flex-1 bg-black">
      ...
      <View className="absolute inset-0 bg-gray-900 overflow-hidden">
        ...
        <View className="flex-1 items-center justify-center">
          <Text className="text-white/20 font-manrope font-black text-4xl transform -rotate-45">
            CAMERA PREVIEW
          </Text>
        </View>
      </View>
      ...
      <View style={StyleSheet.absoluteFill} className="items-center justify-center">
        ...
        <Text className="text-white/80 font-manrope font-bold text-sm mt-10">
        ...
        <View className="absolute bottom-40 left-0 right-0 items-center">
          <View className="flex-row gap-8 bg-black/60 px-8 py-5 rounded-[30] border border-white/10">
            <TouchableOpacity className="items-center">
              ...
              <Text className="text-white/60 text-[10px] font-manrope font-bold uppercase">
                Album
              </Text>
            </TouchableOpacity>
            <TouchableOpacity className="items-center">
