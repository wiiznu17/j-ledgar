    ...
    <SafeAreaView className="flex-1 bg-[#f5f6fc]">
      <View className="flex-1 px-6 items-center">
        ...
        <View className="flex-row items-center justify-between w-full mt-6 mb-10">
          ...
          <Text className="text-xl font-manrope font-black text-on-surface tracking-tight">Receive Assets</Text>
        ...
        <MotiView
           ...
           className="w-full"
        >
          <GlassPanel intensity={40} className="w-full p-10 items-center mb-10 border-white/40 shadow-2xl shadow-primary/5">
             <View className="relative mb-6">
                <Image source={MOCK_USER.avatar} className="w-20 h-20 rounded-[28] border-4 border-white shadow-xl" />
             ...
             <Text className="text-2xl font-manrope font-black text-on-surface mb-1 tracking-tight">{MOCK_USER.name}</Text>
             <View className="flex-row items-center gap-2 mb-10">
                <Text className="text-[10px] font-manrope font-black text-secondary uppercase tracking-[0.2em]">{MOCK_USER.walletId}</Text>
             ...
             >
                <View className="w-full h-full bg-[#f8f9ff] rounded-[35] items-center justify-center border border-primary/5">
                   <Image 
                     source={{ uri: 'https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=JLED-9922-0051&color=4855a5' }} 
        ...
        <View className="flex-row gap-5 w-full mb-12">
           <TouchableOpacity className="flex-1 h-16 rounded-[25] bg-white/60 border border-outline-variant/10 items-center justify-center flex-row gap-3 shadow-sm active:scale-95">
              ...
              <Text className="text-xs font-manrope font-black text-[#4855a5] uppercase tracking-tight">Share QR</Text>
           </TouchableOpacity>
           <TouchableOpacity className="flex-1 h-16 rounded-[25] bg-white/60 border border-outline-variant/10 items-center justify-center flex-row gap-3 shadow-sm active:scale-95">
              <Download size={20} color="#4855a5" />
              <Text className="text-xs font-manrope font-black text-[#4855a5] uppercase tracking-tight">Save Image</Text>
           </TouchableOpacity>
        </View>
        ...
        <GlassPanel intensity={10} className="p-5 flex-row items-center gap-5 border-primary/5">
           ...
           <Text className="text-[10px] font-manrope font-bold text-on-surfaceVariant leading-[1.6] flex-1">
             Your unique J-Ledger ID allows instant peer-to-peer asset transfers with zero network fees.
           </Text>
        </GlassPanel>
      </View>
    </SafeAreaView>
