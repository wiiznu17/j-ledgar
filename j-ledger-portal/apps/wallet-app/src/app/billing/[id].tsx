  ...
  const handleShare = async () => {
    try {
      if (viewShotRef.current?.capture) {
        ...
        await Share.share({
          url: uri,
          message: `J-Ledger Receipt: ${invoice?.invoiceNumber || 'Invoice'}`,
        });
      }
    } catch (error) {
      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
        ...
        <View className="mt-6 px-4">
          <Text className="text-[10px] text-gray-400 text-center font-manrope font-medium leading-4">
            This is an official electronic receipt generated by J-Ledger. You can use this for your financial records.
          </Text>
        </View>
      </ScrollView>
