  ...
  if (isLoading) {
    return (
      <SafeAreaView className="flex-1 items-center justify-center bg-[#f8f9fe]">
        ...
        <Text className="mt-4 text-gray-400 font-manrope font-bold">
    ...
    return (
      <SafeAreaView className="flex-1 bg-[#f8f9fe]">
        <View className="flex-row items-center px-4 py-4">
          ...
          <Text className="text-xl font-black font-manrope text-gray-800 ml-2">
            Merchant Partner
          </Text>
        </View>
        <View className="flex-1 items-center justify-center px-6">
          ...
          <Text
            className={`text-2xl font-black font-manrope ${isRejected ? 'text-red-600' : 'text-gray-800'} text-center mb-3`}
          >
            {isPending
              ? 'Application Pending'
              : isRejected
          ...
          {!isPending ? (
            ...
            >
              <Text className="text-gray-400 text-center font-black font-manrope text-base">
                Back to Profile
              </Text>
            </TouchableOpacity>
          )}
    ...
    return (
      <SafeAreaView className="flex-1 bg-[#f8f9fe]">
        ...
        <View className="flex-1 items-center justify-center px-6">
          ...
          >
            <Text className="text-white font-black font-manrope">
              Retry Connection
            </Text>
          </TouchableOpacity>
        </View>
    ...
    <SafeAreaView className="flex-1 bg-[#f8f9fe]" edges={['top']}>
      ...
      <View className="px-6 pt-4 pb-12 bg-[#1a1a1a] rounded-b-[3.5rem] shadow-2xl shadow-black/20">
        <View className="flex-row items-center justify-between mb-8">
          ...
          <Text className="text-[10px] font-black font-manrope text-white/40 uppercase tracking-[4px]">
            Merchant Mode
          </Text>
        ...
        >
          ...
          <View className="ml-5 flex-1">
            <Text
              className="text-2xl font-black font-manrope text-white tracking-tight"
              numberOfLines={1}
            >
      ...
      >
        ...
        <View className="flex-row flex-wrap justify-between">
          ...
          >
            ...
            <Text className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">
              Sales Today
            </Text>
            <View className="flex-row items-baseline">
              ...
              <Text className="text-[10px] font-bold text-gray-400 ml-0.5">
                .00
              </Text>
            </View>
          </MotiView>
          ...
          >
            ...
            <View className="flex-row items-baseline">
              <Text className="text-xl font-black font-manrope text-gray-800">
                ฿{data?.totalMerchantBalance?.toLocaleString() || '0'}
              </Text>
              <Text className="text-[10px] font-bold text-gray-400 ml-0.5">
                .00
              </Text>
        ...
        {/* Quick Actions Grid */}
        <Text className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-5 ml-2 mt-6">
          Business Operations
        </Text>
          ...
          >
            ...
            >
              <View className="flex-row items-center">
                ...
                <View>
                  <Text className="text-xl font-black font-manrope text-white">
                    Receive Payment
                  </Text>
                  <Text className="text-xs text-white/60 font-bold mt-0.5">
          ...
          <View className="flex-row justify-between">
            ...
            >
              ...
              >
                ...
                <Text className="text-[10px] text-gray-400 font-bold mt-1 uppercase tracking-tighter">
                  View History
                </Text>
              </TouchableOpacity>
            </MotiView>
