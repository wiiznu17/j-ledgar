...
export const SetPasswordStep: React.FC<SetPasswordStepProps> = ({
  ...
  const rules = [
    ...
    },
    {
      ...
      met:
        password.length > 0 &&
        !/(123|234|345|456|567|678|789|890|098|987|876|765|654|543|432|321|210|012|abc|bcd|cde|def|efg|fgh|ghi|hij|ijk|jkl|klm|lmn|mno|nop|opq|pqr|qrs|rst|stu|tuv|uvw|vwx|wxy|xyz|qwe|wer|ert|rty|tyu|yui|uio|iop|pas|asd|sdf|dfg|fgh|ghj|hjk|jkl)/i.test(
          password,
        ) &&
        !/([a-zA-Z0-9])\1{2}/.test(password) &&
        !/(password|admin|user|test|guest|root|login|welcome|hello|monkey|dragon|football|baseball|letmein|master|shadow|sunshine|princess|qwerty)/i.test(
          password,
        ),
    },
    {
