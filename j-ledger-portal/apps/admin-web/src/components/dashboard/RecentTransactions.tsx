...
export function RecentTransactions({ className }: { className?: string }) {
  ...
  return (
    <Card className={`border-none shadow-sm ring-1 ring-slate-100 overflow-hidden flex flex-col ${className}`}>
      <CardHeader className="border-b border-slate-50 bg-white py-4">
        <div className="flex items-center justify-between">
          ...
          <Link href="/transactions" className="text-xs font-bold text-indigo-600 hover:underline flex items-center gap-1">
            View All
        ...
        <Table>
          <TableHeader className="bg-slate-50/50">
            <TableRow className="border-b border-slate-50">
              <TableHead className="text-[10px] font-extrabold uppercase tracking-widest text-slate-400 pl-6 py-3">Type</TableHead>
              <TableHead className="text-[10px] font-extrabold uppercase tracking-widest text-slate-400 py-3">User / Reference</TableHead>
              <TableHead className="text-[10px] font-extrabold uppercase tracking-widest text-slate-400 py-3">Amount</TableHead>
              <TableHead className="text-[10px] font-extrabold uppercase tracking-widest text-slate-400 py-3">Status</TableHead>
              <TableHead className="text-[10px] font-extrabold uppercase tracking-widest text-slate-400 pr-6 py-3 text-right">Date</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {transactions.length > 0 ? (
                ...
                <TableRow key={tx.id} className="border-b border-slate-50 hover:bg-slate-50/30 transition-colors">
                  ...
                  <TableCell className="py-4">
                    <div className="flex flex-col">
                      <span className="text-xs font-bold text-slate-800 truncate max-w-[150px]">{tx.id}</span>
                  ...
                  <TableCell className="py-4">
                    <Badge variant="secondary" className="bg-emerald-50 text-emerald-600 border-emerald-100 text-[10px] font-bold px-2 py-0">
                      SUCCESS
                    </Badge>
                  </TableCell>
              ...
              <TableRow>
                <TableCell colSpan={5} className="py-12 text-center text-slate-400 text-xs font-medium">
