      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-slate-50/50 hover:bg-slate-50/50 border-b border-slate-100">
            <TableHead className="font-bold text-[11px] uppercase tracking-widest text-slate-400 py-4 px-6">
              Report Date
            </TableHead>
            <TableHead className="text-right font-bold text-[11px] uppercase tracking-widest text-slate-400 py-4 px-6">
              System Assets
            </TableHead>
            <TableHead className="text-right font-bold text-[11px] uppercase tracking-widest text-slate-400 py-4 px-6">
              User Liabilities
            ...
            <TableHead className="text-center font-bold text-[11px] uppercase tracking-widest text-slate-400 py-4 px-6">
              Status
            </TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {reports.map((report) => (
            ...
            >
              ...
              <TableCell
                className={`text-right py-4 px-6 font-mono text-sm font-black ${report.discrepancy !== 0 ? 'text-rose-600' : 'text-emerald-600'}`}
              >
              ...
              <TableCell className="text-center py-4 px-6">
                <Badge
                  variant="outline"
                  className={`px-2.5 py-0.5 rounded-full text-[10px] font-black tracking-tight border shadow-sm ${getStatusStyle(report.status)}`}
                >
                  {report.status}
                </Badge>
              </TableCell>
