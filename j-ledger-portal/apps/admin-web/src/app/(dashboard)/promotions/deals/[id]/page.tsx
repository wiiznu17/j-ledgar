      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground font-medium">
            Reward ID:{' '}
            <span className="font-mono text-xs uppercase">{deal.id}</span>
          </p>
        </div>
        <Button
        ...
        <div className="lg:col-span-2 space-y-8">
          <Card className="border-none shadow-xs rounded-[2rem] overflow-hidden bg-card text-card-foreground">
            ...
            <CardContent className="p-8 space-y-6">
              <div>
                <h3 className="text-xs font-black text-muted-foreground uppercase tracking-[0.2em] mb-3">
                  Description
                </h3>
            ...
            <CardContent className="p-0 space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-black text-foreground">
                      {deal.remainingStock.toLocaleString()} /{' '}
                      {deal.stock.toLocaleString()}
                    </p>
                  </div>
                </div>
                <div className="text-right">
                  ...
                  <p className="text-lg font-black text-foreground">
                    {(deal.stock - deal.remainingStock).toLocaleString()}
                  </p>
                </div>
              </div>
            ...
            <CardContent className="p-0 space-y-4">
              <div className="space-y-1">
                ...
                <p className="text-sm font-bold text-foreground">
                  {deal.startDate
                    ? format(new Date(deal.startDate), 'PPP')
                    : 'No start date'}
                </p>
              </div>
              <div className="space-y-1">
