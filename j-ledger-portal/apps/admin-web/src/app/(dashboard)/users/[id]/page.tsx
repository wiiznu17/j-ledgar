    ...
    <div className="space-y-5 pb-10 max-w-6xl mx-auto text-foreground">
      ...
      <div className="grid gap-5 lg:grid-cols-3 items-stretch">
        ...
        <div className="lg:col-span-2">
          {/* USER HERO CARD */}
          <Card className="h-full border-none shadow-xs bg-card text-card-foreground overflow-hidden rounded-[2rem]">
            ...
            <CardHeader className="relative pb-0">
              <div className="absolute -top-16 left-8 p-1.5 bg-card border border-border rounded-[2rem] shadow-xl">
                <div className="w-24 h-24 rounded-[1.6rem] bg-slate-900 dark:bg-slate-800 flex items-center justify-center text-white overflow-hidden border-4 border-card">
                ...
                <div>
                  ...
                  <div className="flex items-center flex-wrap gap-x-4 gap-y-2 mt-1.5">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <Link href={`/risk/kyc/${user.id}`}>
                        <Button
                          variant="ghost"
                          size="sm"
                          className="h-5 w-5 p-0 text-muted-foreground hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-500/10 rounded-md"
                        >
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <Badge className="bg-amber-500/10 text-amber-600 dark:text-amber-400 border-none text-[10px] font-black rounded-lg px-2 py-0.5 uppercase tracking-tighter flex items-center gap-1">
            ...
            <CardContent className="grid md:grid-cols-2 gap-10 p-10 pt-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span
                      className={cn(
                        'text-sm font-bold',
                        user.email ? 'text-foreground' : 'text-muted-foreground italic',
                      )}
                    >
                      {user.email || 'not set'}
                    </span>
              ...
              <div className="space-y-6">
                ...
                {account ? (
                  <div className="p-6 rounded-[1.5rem] bg-muted/30 ring-1 ring-border space-y-4 relative group hover:ring-indigo-200 transition-all cursor-pointer overflow-hidden">
                    ...
                    <div className="flex items-center justify-between relative z-10">
                      ...
                      <Badge
                        variant="outline"
                        className="bg-card border-border text-[9px] font-black text-muted-foreground rounded-md"
                      >
                        {account.status}
                      </Badge>
                    </div>
                  ...
                  <div className="p-6 rounded-[1.5rem] bg-amber-500/10 ring-1 ring-amber-500/20 flex flex-col items-center justify-center text-center gap-2 border border-dashed border-amber-500/30">
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center">
                        <Activity className="w-3.5 h-3.5 mr-2 text-muted-foreground group-hover:text-indigo-500" />
            ...
            <CardContent className="p-0">
              <div className="divide-y divide-border px-4">
                {activity?.devices?.map((device: any, idx: number) => (
                  <div
                    key={idx}
                    className="p-3 flex items-center justify-between hover:bg-muted/50 transition-colors rounded-xl my-1 group"
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-muted flex items-center justify-center border border-border group-hover:bg-card group-hover:shadow-xs transition-all">
                        ...
                        <DialogTrigger
                          render={
                            <Button
                              variant="ghost"
                              size="sm"
                              className="h-6 w-6 p-0 text-muted-foreground/50 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-500/10 rounded-md"
                            />
                          }
                        >
                          ...
                          <div className="space-y-6 pt-4">
                            <div className="p-4 bg-muted/50 rounded-2xl space-y-3">
                              ...
                              <div className="flex flex-col gap-1">
                                ...
                                <span className="text-[10px] font-mono font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-500/10 p-2 rounded-lg break-all">
