        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Configure global merchant commissions, tax parameters, transfer
              fees, and system limits.
            </p>
          </div>
        </div>
        <Button
      ...
      >
          ...
          <CardContent className="p-6 space-y-5">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
              <div className="space-y-2">
                <Label
                  htmlFor="merchantFeeRate"
                  className="text-[10px] font-black uppercase text-muted-foreground tracking-wider"
                >
                  Merchant MDR Rate
                </Label>
                <div className="relative flex items-center">
                  <span className="absolute left-3 text-xs font-black text-muted-foreground select-none">
                    %
                  </span>
                  <Input
                    id="merchantFeeRate"
                    ...
                    onChange={(e) =>
                      updateField('merchantFeeRate', parseFloat(e.target.value))
                    }
                ...
                <p className="text-[10px] text-muted-foreground font-medium">
                  Current: {(settings.merchantFeeRate * 100).toFixed(2)}%
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative flex items-center">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateField('vatRate', parseFloat(e.target.value))
                    }
                    className="pl-7 font-mono font-semibold border-border bg-muted/20 text-foreground rounded-xl focus-visible:ring-indigo-500"
                  />
                </div>
                <p className="text-[10px] text-muted-foreground font-medium">
                  Current: {(settings.vatRate * 100).toFixed(2)}%
                </p>
              </div>

              <div className="space-y-2">
                <Label
                  htmlFor="minMerchantPayment"
                  className="text-[10px] font-black uppercase text-muted-foreground tracking-wider"
                >
                  Min Payment (฿)
                </Label>
                <div className="relative flex items-center">
                  <span className="absolute left-3.5 text-xs font-black text-indigo-600 dark:text-indigo-400 select-none">
                    ฿
                  </span>
                  <Input
        ...
        <Card className="border border-border shadow-xs overflow-hidden bg-card text-card-foreground rounded-[2rem] transition-all duration-300 hover:shadow-md">
          <CardHeader className="bg-muted/30 border-b border-border p-6">
            ...
            <CardDescription className="text-xs text-muted-foreground mt-1">
              Daily and per-transaction monetary caps enforced for system
              security.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="border border-border shadow-xs overflow-hidden bg-card text-card-foreground rounded-[2rem] lg:col-span-2 transition-all duration-300 hover:shadow-md">
          <CardHeader className="bg-muted/30 border-b border-border p-6">
            ...
            <CardDescription className="text-xs text-muted-foreground mt-1">
              Fixed and variable processing fees for P2P transfers, cash
              withdrawals, and utility bills.
            </CardDescription>
          </CardHeader>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="space-y-1">
                      ...
                      <div className="relative flex items-center">
                        <span className="absolute left-3 text-xs font-black text-indigo-600 dark:text-indigo-400 select-none">
                          ฿
                        </span>
                        <Input
                          type="number"
            ...
            <div className="flex items-center justify-between py-2 bg-muted/30 px-4 rounded-xl border border-border/50">
              <div className="space-y-0.5">
                ...
                <p className="text-[10px] text-muted-foreground">
                  Require Multi-Factor authentication for administrative logins.
                </p>
              </div>
