        ...
        <div className="lg:col-span-1 flex flex-col gap-6">
          <Card className="border-none shadow-lg rounded-2xl overflow-hidden bg-white flex-1 flex flex-col">
            ...
            <CardContent className="pt-0 -mt-12 text-center pb-8 px-6 flex-1 flex flex-col">
              ...
              <h2 className="text-xl font-bold text-slate-900 leading-tight">{admin?.firstName} {admin?.lastName}</h2>
              <p className="text-sm text-slate-500 mb-4">{admin?.email}</p>
              <Badge variant="outline" className="bg-indigo-50 text-indigo-700 border-indigo-100 font-bold text-xs px-3 py-1 self-center">
                {admin?.role}
              </Badge>
              ...
              <div className="mt-8 pt-8 border-t border-slate-50 flex flex-col gap-5 text-left">
                <div className="flex items-center gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs font-bold text-emerald-600 uppercase truncate">Verified Active</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
              ...
              <div className="mt-auto pt-8">
                <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-4 text-left">Quick Navigation</h4>
                <div className="space-y-2">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs font-bold text-slate-600 group-hover:text-indigo-700">My Audit Logs</span>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs font-bold text-slate-600 group-hover:text-indigo-700">Security Activity</span>
                    </div>
                    <ArrowRight className="w-3.5 h-3.5 text-slate-300 group-hover:text-indigo-400 group-hover:translate-x-0.5 transition-all" />
                  </Link>
                </div>
              ...
              <form onSubmit={handleUpdateProfile} className="h-full flex flex-col space-y-6">
                ...
                <div className="bg-indigo-50/50 rounded-2xl p-6 border border-indigo-100/50 flex flex-col gap-2 mt-auto">
                  ...
                  <p className="text-xs text-indigo-700/70 leading-relaxed font-medium">
                    Your profile information is visible to other system administrators. For security reasons, sensitive data like your email and system role can only be modified by a Super Administrator.
                  </p>
                </div>
                ...
                <div className="flex justify-end pt-4">
                  ...
                  >
                    {isUpdatingProfile ? <RefreshCcw className="w-4 h-4 animate-spin" /> : <><Save className="w-4 h-4 mr-2" /> Save Profile Changes</>}
                  </Button>
                </div>
              </form>
            </CardContent>
