...
export const userRequester = {
  ...
  getWalletUserStats: async (options?: RequestOptions) => apiClient.get<any>(API_PATHS.ADMIN.USERS.WALLET_STATS, options),
  ...
  getAdminUsers: async (options?: RequestOptions) => apiClient.get<AdminPaginatedResponse<AdminUser>>(API_PATHS.ADMIN.STAFF.BASE, options),
  ...
  createAdmin: async (data: any, options?: RequestOptions) => apiClient.post<AdminUser>(API_PATHS.ADMIN.STAFF.BASE, data, options),
  deleteAdmin: async (id: string, options?: RequestOptions) => apiClient.delete<void>(API_PATHS.ADMIN.STAFF.DETAIL(id), options),
  getAdminDetail: async (id: string, options?: RequestOptions) => apiClient.get<AdminUser>(API_PATHS.ADMIN.STAFF.DETAIL(id), options),
  updateAdmin: async (id: string, data: any, options?: RequestOptions) => apiClient.put<AdminUser>(API_PATHS.ADMIN.STAFF.DETAIL(id), data, options),
  deactivateAdmin: async (id: string, options?: RequestOptions) => apiClient.post<void>(API_PATHS.ADMIN.STAFF.DEACTIVATE(id), {}, options),
  reactivateAdmin: async (id: string, options?: RequestOptions) => apiClient.post<void>(API_PATHS.ADMIN.STAFF.REACTIVATE(id), {}, options),
  resetAdminPassword: async (id: string, options?: RequestOptions) => apiClient.post<void>(API_PATHS.ADMIN.STAFF.RESET_PASSWORD(id), {}, options),
  resendAdminInvite: async (id: string, options?: RequestOptions) => apiClient.post<void>(API_PATHS.ADMIN.STAFF.RESEND_INVITE(id), {}, options),
  ...
  getUserAccount: async (userId: string) => apiClient.get<any>(API_PATHS.ADMIN.ACCOUNTS.BY_USER(userId)),
  ...
  updateRole: async (id: string, data: any) => apiClient.put<any>(API_PATHS.ADMIN.ROLES.DETAIL(id), data),
